...
```
Output
 ![image](https://github.com/user-attachments/assets/7fa1ab6e-4378-4440-83ec-aaaf5eb602b3)
...
```
Output: 
 ![image](https://github.com/user-attachments/assets/5b334600-ac78-44dd-8307-2e30c70a0bb1)
...
```
Output:
 ![image](https://github.com/user-attachments/assets/d95a8d21-98df-4d6f-a4b4-604ad4a4e2be)
...
```
Output: 
 ![image](https://github.com/user-attachments/assets/3dc3c473-afe4-4e4a-941a-c3f74e037613)
...
```
Output: 
 ![image](https://github.com/user-attachments/assets/f1c6c18c-4708-418b-9f43-384fbb9d4f24)
